...
class ErrorListener(object):
    ...
    def getError(self, recognizer, dfa, startIndex, stopIndex, prediction, configs):
        return ("line " + str(line) + ":" + str(column) + " " + msg)
...
class ConsoleErrorListener(ErrorListener):
    ...
    #
    def syntaxError(self, recognizer, offendingSymbol, line, column, msg, e):
        error.append("Строка " + str(line) + ":" + str(column) + " " + msg)
